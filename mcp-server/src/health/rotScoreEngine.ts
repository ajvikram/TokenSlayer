/**
 * Converts raw RotSignals into a composite rot score and ModelRecommendation.
 * Pure functions — no I/O, no vscode dependency.
 */
import type { RotSignals, RotSeverity, ModelRecommendation, SessionHealth, TaskComplexity } from './types.js';
import type { AnalysisResult } from './contextRotAnalyzer.js';
